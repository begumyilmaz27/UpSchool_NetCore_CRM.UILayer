...
namespace NetCore_CRM.DataAccessLayer.Migrations
{
    ...
    [Migration("20221121041052_employeetask_table")]
    partial class employeetask_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetCore_CRM.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NetCore_CRM.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("NetCore_CRM.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("NetCore_CRM.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NetCore_CRM.EntityLayer.Concrete.EmployeeTask", b =>
                {
                    b.HasOne("NetCore_CRM.EntityLayer.Concrete.AppUser", "AppUser")
                        .WithMany()
                        .HasForeignKey("AppUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NetCore_CRM.EntityLayer.Concrete.Employee", null)
